...
int dir_reader(int img, long int block_size, int upper_bound, uint32_t* blocks, const char* left_path, char entry_type){
...
//---------------------------------------------------------------------------------------------------------------------------------------	
	...
	res = dir_reader(img, block_size, block_size/4, x1blocks, path, entry_type);
